<?php
if(!isset($_GET['id'])){
header('Location: http://localhost/SelectedTopicInHCI/feeling/home1.php');
exit(0);
}
                    ...
                    <div class="col-md-6">
                        <div class="container2 clearfix">
                            <div class="gallery">
                                <div class="previews">
                                    <?php
                                    $sql = 'SELECT * from picture where pid="'.$_GET['id'].'" && type = "f"';
                                    $result = mysqli_query($conn, $sql);
                                    $count = $result->num_rows - 1;
                                    $row = mysqli_fetch_assoc($result);
                                    $firstPic = $row['picloc'];
                                    $sql2 = 'SELECT * from picture where pid="'.$_GET['id'].'" && type = "t"';
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a class="btn btn-info btn-lg" onclick="buy( < ?php echo $row1['pid']; ? > , < ?php echo $row1['price']; ? > );">ใส่ตะกร้า<i class="fa fa-fw fa-shopping-cart"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" style="padding-right: 0;">
                        ...
                        <ul class="nav nav-tabs tabs-left">
                            <li class="active"><a href="#home" data-toggle="tab">ความคิดเห็น</a></li>
                            <li><a href="#profile" data-toggle="tab">คะเเนน</a></li>
                            <li><a href="#messages" data-toggle="tab">กราฟ</a></li>
                    ...
                    <div class="col-md-9" >
                        ...
                        <div class="tab-content" >
                            ...
                            <div class="tab-pane" id="profile">คะแนนเฉลี่ยความพึงพอใจ <br />
                              <div id="rateYo">
                                </div><input type="hidden" value="1" name="rateyoid" id="rateyoid">
                              </div>
